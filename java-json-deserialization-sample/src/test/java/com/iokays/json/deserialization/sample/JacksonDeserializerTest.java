// Path: Samples/java-json-deserialization-sample/src/test/java/com/iokays/json/deserialization/sample/JacksonDeserializerTest.java
...
/**
 * JacksonDeserializer 的单元测试。
 * 验证 Jackson 是否能正确保留所有数据类型。
 */
class JacksonDeserializerTest {
    ...
    void testDeserialize() {
        ...
        assertEquals("筋斗云", ((ArrayList<?>) hobbies).get(0));
